...
export class initial1583488759712 implements MigrationInterface {
    name = 'initial1583488759712'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "contracts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" text NOT NULL, "lastName" text NOT NULL, "age" integer NOT NULL, "pickupDate" TIMESTAMP WITH TIME ZONE NOT NULL, "estimatedReturnDate" TIMESTAMP WITH TIME ZONE NOT NULL, "returnDate" TIMESTAMP WITH TIME ZONE NOT NULL, "isClosed" boolean NOT NULL DEFAULT false, "carId" uuid, CONSTRAINT "PK_2c7b8f3a7b1acdd49497d83d0fb" PRIMARY KEY ("id"))`, undefined);
